    ...
    <div className="bg-black">
      <section className="w-screen h-screen flex items-center flex-col bg-[url('assets/images/mountain-x.jpg')] bg-cover bg-center">
        <div className=" w-screen h-screen grid grid-rows-6 grid-flow-col justify-center content-center text-white pt-20 bg-gradient-to-t from-black">
          ...
          <div className="text-2xl text-center pt-2">For. The. Kids.</div>
          </div>
      ...
      <section className="   flex-col sm:flex-row h-full  flex  border-gray-700 border-t-8  min-half-screen  w-full z-50 text-white   bg-black">
        <div className="flex my-auto h-full justify-center   items-center  flex-col sm:w-1/2 w-full p-12">
          <div className="text-xl w-fit text-4xl"><strong>Platform for teachers to share educational content, indexed to structured curriculums.</strong></div>
      ...
      <section className="   flex-col sm:flex-row h-full  flex  border-gray-700 border-t-8  min-half-screen  w-full z-50 text-white   bg-black">
        ...
        <div className="flex my-auto h-full justify-center   items- center  flex-col sm:w-1/2 w-full p-12">
        <div className="text-xl w-fit text-4xl"> <strong>Data insights to provide teachers real time feedback on the classroom’s progression. </strong></div>
          <div className="text-xl w-fit pt-10">Walk into the classroom armed with actionable insights. FTK enables teachers to spend more time with students, building relationships and coaching to their individual needs, and less time manually reviewing assignments.</div>
          <div className="text-xl w-fit">For example, FTK may suggest covering a specific example problem that the majority of the class struggled with, or provide a list of students at risk of falling behind or becoming disengaged.</div>
        </div>
      </section>

      <section className="   flex-col sm:flex-row h-full  flex  border-gray-700 border-t-8  min-half-screen  w-full z-50 text-white   bg-black">
        <div className="flex my-auto h-full justify-center   items-center  flex-col sm:w-1/2 w-full p-12">
          <div className="text-xl w-fit text-4xl"><strong>Real time project collaboration between teachers and students</strong></div>
